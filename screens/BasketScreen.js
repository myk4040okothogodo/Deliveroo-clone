...
//import { removeFromBasket } from "../features/baske"
      ...
      <View className="flex-1 bg-gray-100">
       ...
       <View className="p-5 bg-white mt-5 space-y-4">
        ...
        <View className="flex-row justify-between" >
          ...
          <Text className="text-gray-400">
            <Currency quantity={5.99}  currency="KES" />
          </Text>
        </View>
        
        <View className="flex-row justify-between" >
          <Text >Order Total</Text>
          <Text className="font-extabold">
            <Currency quantity={basketTotal+5.99}  currency="KES" />
          </Text>
        </View>
